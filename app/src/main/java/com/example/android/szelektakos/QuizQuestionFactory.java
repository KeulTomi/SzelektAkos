...
public class QuizQuestionFactory {
    ...
    public static QuizQuestionFactory questionFactory () {
        QuizQuestionFactory question = new QuizQuestionFactory();
        Random r = new Random();
        int questionNumber = r.nextInt(question.questions.length);
        question.mQuestion = question.questions[questionNumber];
        question.mFirstAnswer = question.firstAnswersArray[questionNumber];
        question.mSecondAnswer = question.secondAnswersArray[questionNumber];
        question.mThirdAnswer = question.thirdAnswersArray[questionNumber];
        question.mCorrectAnswer = question.correctAnswersArray[questionNumber];

        return question;
    }


    public String getmFirstAnswer() {
        return mFirstAnswer;
    }

    public String getmSecondAnswer() {
        return mSecondAnswer;
    }

    public String getmThirdAnswer() {
        return mThirdAnswer;
    }

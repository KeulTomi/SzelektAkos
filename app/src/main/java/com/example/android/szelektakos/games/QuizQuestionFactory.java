...
public class QuizQuestionFactory {
    ...
    private static List<String> dinamicQuestionList = new ArrayList<String>(Arrays.asList(questions));
    private static List<String> dinamicFirstAList = new ArrayList<String>(Arrays.asList(firstAnswersArray));
    private static List<String> dinamicSecondAList = new ArrayList<String>(Arrays.asList(secondAnswersArray));
    private static List<String> dinamicThirdAList = new ArrayList<String>(Arrays.asList(thirdAnswersArray));
    private static List<Integer> dinamicCorrectAList = new ArrayList<Integer>(Arrays.asList(correctAnswersArray));
